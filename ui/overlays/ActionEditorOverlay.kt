...
class ActionEditorOverlay(
    ...
    private fun bindUi(view: View, config: ActionConfig) {
        ...
        btnTypeClick.setOnClickListener { service.vibrateFeedback(20L); applyType(ActionType.CLICK) }
        btnTypeHold.setOnClickListener { service.vibrateFeedback(20L); applyType(ActionType.LONG_PRESS) }
        btnTypeSwipe.setOnClickListener { service.vibrateFeedback(20L); applyType(ActionType.SWIPE) }
        btnTypeTrigger.setOnClickListener { service.vibrateFeedback(20L); applyType(ActionType.TRIGGER) }
