...
def write_file(rel_path, content):
    ...
    with open(full_path, "w", encoding="utf-8") as f:
        f.write(content)
    print(f"  [✓] Исправлен оверлей v37.7: {rel_path}")

def fix_control_panel_bubble_bug():
    print("🚀 Фикс кнопки-пузырька в ControlPanelOverlay v37.7.0-PRO...")
...
"""
    ...
    # 2. ControlPanelOverlay.kt (Фикс видимости btnSingleBubble = View.VISIBLE для состояния 2)
...
"""
    ...
    print("✨ Баг с кнопкой-пузырьком в ControlPanelOverlay успешно исправлен!")

if __name__ == "__main__":
    fix_control_panel_bubble_bug()